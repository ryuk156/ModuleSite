...
import { Table, NavLink, Input, Row, ModalBody, Col, Alert } from "reactstrap";
import defaultprofile from "../../../static/logos/profile-placeholder.png";
import moment from "moment-timezone";
import MentorModal from "../Modal/Modal.jsx";
const Mentor = () => {
                  ...
                  <div class="card-body">
                    <Row className="justify-content-center">
                      ...
                      <Col lg="10" md="12" className="text-center pt-0">
                        ...
                        <div>
                          <MentorModal name={mentor.name} desc={mentor.desc} tags={mentor.labels} customInfo={mentor.customFieldItems} timeZone={timeZone} country={countryName} />
                        </div>
                      </Col>
                    </Row>
                  </div>
